...
import com.pmolinav.prediction.services.PlayerBetSelectionService;
...
public class PlayerBetSelectionController {
    ...
    @Autowired
    private PlayerBetSelectionService playerBetSelectionService;
    ...
    public ResponseEntity<?> createSelection(@RequestParam String requestUid,
        ...
        try {
            Long createdId = playerBetSelectionService.create(playerBetSelectionDTO);
    ...
    public ResponseEntity<?> deleteSelection(@RequestParam String requestUid,
                                             @PathVariable Long id) {
        try {
            playerBetSelectionService.delete(id);

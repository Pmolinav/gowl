...
cd /d "%BASE_DIR%..\..\libraries\shared-lib"
call mvn clean install -DskipTests > build.log 2>&1 || (echo Build failed for shared-lib. See build.log && exit /b 1)
echo [[32mshared-lib OK[0m]
del build.log
